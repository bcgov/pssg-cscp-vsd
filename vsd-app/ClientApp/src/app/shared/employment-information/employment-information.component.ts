...
export class EmploymentInformationComponent extends FormBase implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.employedAtTimeOfCrimeSubscription = this.form
      .get('wereYouEmployedAtTimeOfCrime')
    ...
    this.atWorkAtTimeOfCrimeSubscription = this.form
      .get('wereYouAtWorkAtTimeOfIncident')
      .valueChanges.subscribe((value) => {
